...
public class FourQueens {
	 ...
	 */
	boolean solveNQUtil(int board[][], int numberOfQueens) {
		/*
		...
		for (int i = 0; i < N; i++) {
			 ...
			 */
			if (isSafe(board, i, numberOfQueens)) {
				/* Place this queen in board[i][col] */
				board[i][numberOfQueens] = 1;

				/* recur to place rest of the queens */
				if (solveNQUtil(board, numberOfQueens+1) == true)
					return true;
				 ...
				 */
				board[i][numberOfQueens] = 0; // BACKTRACK
			}
		}
	...
	public static void main(String args[]) {
		FourQueens Queen = new FourQueens();
		Queen.solveNQ();
	}
}